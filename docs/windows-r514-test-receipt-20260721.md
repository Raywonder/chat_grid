# Windows Indiginous R514 test receipt
...
- Installer: `IndiginousSetup-0.4.3-R514.exe`
...
- Cleanup: the test process was stopped and the temporary `Indiginous-R514-Test` scheduled task was removed.

# Endiginous 0.4.5 install-replacement release
...
Endiginous 0.4.5 is published for Windows and macOS. Existing installs now replace the complete application payload during upgrade, so files removed or renamed by newer builds are not left behind. Legacy install directories, shortcuts, and autorun entries are still cleaned by the migration layer, while user data is preserved in the current Endiginous data directory.

## Windows proof

- Build host: approved Windows 11 VM, Windows 11, Python 3.13.14, wxPython 4.2.5.
- Tests: 39 passed.
- Artifact: `desktop/native/windows/release/EndiginousSetup-0.4.5.exe`
...
- ZIP: `desktop/native/macos/release/Endiginous-0.4.5-macOS.zip`
- ZIP SHA-256: `81a52a914fb9c4f2e2514a0bf50b8d10621dc12efcba0710fb9c13d2d9a44839`
- DMG: `desktop/native/macos/release/Endiginous-0.4.5.dmg`
- DMG SHA-256: `d9ef2f92589c6bb43a193ae21bb8c5d7a6873a1fed58c24ea1181b8a94afb370`
- A temporary Mac upgrade simulation replaced an old `Endiginous.app` bundle and proved the stale bundle file was absent afterward.
...
`/home/tappedin/OpenCloud/Agent Reports/Endiginous Backups/endiginous-before-045-20260723/`

# Indiginous R516 public download release

Date: 2026-07-23 CDT
Source commit: `cf4bdf4` (`Stabilize Indiginous browser and desktop clients`)
Browser release: `0.4.4 / R516`

## Published and verified

- Browser: `https://blind.software/indiginous/` returned HTTP 200 and served
  version `0.4.4 / R516`.
- Windows installer: `IndiginousSetup-0.4.4.exe` returned HTTP 200, size
...
- Existing public files were backed up at:
  `/home/tappedin/.openclaw/workspace/recovery/indiginous-public-before-r516-20260723-0040/`.

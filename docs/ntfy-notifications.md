# Indiginous identity ntfy notifications

- Owner: Indiginous / TappedIn platform service, managed by Devine Creations/TappedIn.
...
- Opt-in: disabled by default for existing and future Indiginous identities. Users control it in App settings.
...
- Webhooks/callbacks: none. Indiginous publishes outbound JSON to ntfy when its notification service creates a targeted identity event.

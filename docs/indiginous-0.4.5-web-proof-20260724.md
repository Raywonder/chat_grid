# Indiginous 0.4.5 web proof — 2026-07-24

- Source: `projects/chat_grid`, client `0.4.5`, revision `R518`.
- Client lint passed; web test suite passed: 25 tests.
- Published and checked both `https://blind.software/indiginous/` and the compatibility path `https://blind.software/chatgrid/`.
...
- Both public WebSocket endpoints complete a TLS handshake and return `auth_required` with `Indiginous`, release `0.4.5`, expected client `R518`, and server `0.4.5 S424`.
...
- Recovery backup: `/home/tappedin/OpenCloud/Agent Reports/Indiginous Backups/indiginous-before-web-045-20260724/`.

...
const MAIN_MODE_COMMANDS: MainModeCommandDescriptor[] = [
  ...
  },
  {
    ...
    label: 'Radio remote first station',
    shortcut: 'Home',
    tooltip: 'Tune connected radios to the first preset while holding a radio remote.',
    section: 'Radio',
    isAvailable: (context) => context.hasCarriedRadioRemote,
  },
  {
    id: 'radioRemoteStationLast',
    label: 'Radio remote last station',
    shortcut: 'End',
    tooltip: 'Tune connected radios to the last preset while holding a radio remote.',
    section: 'Radio',
    isAvailable: (context) => context.hasCarriedRadioRemote,
  },
  {
  ...
  },
  {
    ...
    label: 'Radio remote power',
    shortcut: 'O',
    tooltip: 'Switch connected radios on or off while holding a radio remote.',
    section: 'Radio',
    isAvailable: (context) => context.hasCarriedRadioRemote,
  },
  {
    id: 'radioRemoteInfo',
    label: 'Radio remote information',
    shortcut: 'I',
    tooltip: 'Read the connected radio station, power, volume, and now-playing state.',
    section: 'Radio',
    isAvailable: (context) => context.hasCarriedRadioRemote,
  },
  {

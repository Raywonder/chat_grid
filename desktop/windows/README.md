# Indiginous Windows Desktop

This is the first official Windows desktop shell for Indiginous. It wraps the existing web client in Electron so the audio, WebRTC, sign-in, controls, and item logic stay shared with the browser client.

The app defaults to the live Indiginous at:

```text
https://blind.software/indiginous/
```
...
- `Ctrl+Shift+U`: switch between live and local Indiginous URL
- `Ctrl+Shift+I`: developer tools

## Notes

- The wrapper intentionally reuses the current web app instead of duplicating Indiginous behavior.

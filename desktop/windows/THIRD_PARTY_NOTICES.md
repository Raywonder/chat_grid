...
Indiginous source code is distributed under the MIT License in `LICENSE`.
...
Indiginous is the Raywonder/TappedIn branded continuation of Chat Grid, which
...
Indiginous can play or reference them.
...
"Indiginous," "Chat Grid," "Jage9," station names, show names, organization

...
def test_server_url_accepts_domain_and_uses_indiginous_path():
    assert MainFrame._server_url("example.com") == "https://example.com/indiginous/"


def test_server_url_preserves_https_port_but_not_user_path():
    assert MainFrame._server_url("https://grid.example:8443/anything") == "https://grid.example:8443/indiginous/"

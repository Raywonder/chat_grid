...
ditto -c -k --sequesterRsrc --keepParent "dist/Endiginous.app" "macos/release/Indigenous-0.4.6-macOS.zip"
...
hdiutil create -volname "Indigenous" -srcfolder macos/dmg-root -ov -format UDZO "macos/release/Indigenous-0.4.6.dmg"

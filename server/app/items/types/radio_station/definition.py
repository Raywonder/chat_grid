...
PROPERTY_METADATA: dict[str, dict[str, object]] = {
    ...
    "speakerProfile": {
        ...
        "tooltip": "Optional named speaker profile used by the room audio system.",
        "maxLength": 80,
    },
    "linkedMediaGroup": {
        "valueType": "text",
    ...
    "mediaPowerSound": {"valueType": "text", "label": "Power sound", "tooltip": "Sound for this radio turning on or off.", "maxLength": 2048},
    "mediaVolumeSound": {"valueType": "text", "label": "Volume sound", "tooltip": "Sound for this radio volume changing.", "maxLength": 2048},
    "mediaGuideSound": {"valueType": "text", "label": "Guide sound", "tooltip": "Sound for opening this radio guide.", "maxLength": 2048},
    "mediaInfoSound": {"valueType": "text", "label": "Info sound", "tooltip": "Sound for reading this radio state.", "maxLength": 2048},
    "roomImpulseUrl": {
        "valueType": "sound",
        "label": "Room impulse",
        "tooltip": "Optional room impulse response used for this radio's spatial sound.",
        "maxLength": 2048,
    },
    "stationName": {
        "valueType": "text",
